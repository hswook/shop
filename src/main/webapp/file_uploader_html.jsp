...
<%
out.println("not html5 file upload process start");
String return1="";
String return2="";
String return3="";
			...
			if(item.getSize() > 0) {
				...
				filename_ext = filename_ext.toLowerCase();
			   	...
			   	if(cnt == 0) {
		    		...
		    		//파일 기본경로 _ 상세경로
		    		String filePath = dftFilePath + File.separator + "upload" + File.separator +"image" + File.separator;
		    		...
		    		return3 += "&sFileURL=/upload/image/"+realFileNm;
			   	}
			}else {
